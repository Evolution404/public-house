  ...
  render(){
    ...
    let changePart = [
      ...
      (
        <div>
          <Row style={{marginTop: 20}}>
            <Label label="使用面积:" value={this.props.useArea+'㎡'}></Label>
            <Label label="管&nbsp;&nbsp;理&nbsp;&nbsp;者:" value={this.props.manager}></Label>
    ...
    return <div>
        <div style={{marginLeft: '10%', width: '80%'}}>
          ...
          <Row style={{marginTop: 20}}>
            <Label label="楼宇名称:" value={this.props.building}></Label>
            <Label label="所在楼层:" value={this.props.floor}></Label>
            <Label label="房&nbsp;&nbsp;间&nbsp;&nbsp;号:" value={this.props.roomNum}></Label>
          </Row>
          <Split></Split>
          {
